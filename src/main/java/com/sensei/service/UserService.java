...
import com.sensei.repository.AuthorityRepository;
...
import com.sensei.service.util.RandomUtil;
...
public class UserService {
    ...
    public User createUser(UserDTO userDTO) {
        ...
        //dont generate random password for new user for development purpose only
    ...
    public void updateUser(Set<Authority> authorities) {
        userRepository.findOneByLogin(SecurityUtils.getCurrentUserLogin()).ifPresent(user -> {
            user.setAuthorities(authorities);
            log.debug("Changed Information for User: {}", user);
        });
