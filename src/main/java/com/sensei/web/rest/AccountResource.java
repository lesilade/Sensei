...
import com.sensei.security.SecurityUtils;
import com.sensei.service.MailService;
import com.sensei.service.UserService;
import com.sensei.service.dto.UserDTO;
import com.sensei.web.rest.vm.ActivateUserVm;
import com.sensei.web.rest.vm.KeyAndPasswordVM;
import com.sensei.web.rest.vm.ManagedUserVM;
import com.sensei.web.rest.vm.RegisterUserVM;
...
public class AccountResource {
    ...
    public ResponseEntity registerAccount(@Valid @RequestBody RegisterUserVM managedUserVM) {
        ...
        //textPlainHeaders.add("Access-Control-Allow-Origin","*");
        //textPlainHeaders.add("Access-Control-Allow-Methods", "GET, POST, DELETE, PUT");
    ...
    @Timed
    public ResponseEntity<String> activateUser(@Valid @RequestBody ActivateUserVm activateUserVm) {
        return userService.activateRegistration(activateUserVm.getKey())
            .map(user -> new ResponseEntity<String>(HttpStatus.OK))
            .orElse(new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR));
    }
