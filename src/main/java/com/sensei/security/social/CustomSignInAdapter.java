package com.sensei.security.social;
...
public class CustomSignInAdapter implements SignInAdapter {
   ...
   // @SuppressWarnings("unused")
    ...
    private final SenseiProperties jHipsterProperties;

    private final TokenProvider tokenProvider;


    public CustomSignInAdapter(UserDetailsService userDetailsService, SenseiProperties jHipsterProperties,
    ...
    public String signIn(String userId, Connection<?> connection, NativeWebRequest request){
        try {
            ...
            String jwt = tokenProvider.createToken(authenticationToken, false, null);
